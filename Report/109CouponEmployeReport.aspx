<%@ Page Title="My Coupon List" Language="C#"  MasterPageFile="~/DFS.Master" AutoEventWireup="true" CodeBehind="109CouponEmployeReport.aspx.cs" Inherits="DFS.Web.Report._109CouponEmployeReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="/Scripts/Forms/EmployeeCouponList.js" type="text/javascript"> </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="pnlDateSelector" runat="server" GroupingText="My Coupon List" CssClass="fivepixelbottommargin">       
