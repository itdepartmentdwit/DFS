<%@ Page Title="Expense Report" Language="C#" MasterPageFile="~/DFS.Master" AutoEventWireup="true" CodeBehind="ExpenseReport.aspx.cs" Inherits="DFS.Web.Report.ExpenseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel runat="server" ID="filterPanel" GroupingText="Filters">
        ...
        <asp:Panel runat="server" ID="searchByFilterPanel" Visible="false" CssClass="fivepixelbottommargin">
            ...
            <cc:GroupedDropDownList
             ...
             <%--   <td>      
                    <asp:Label runat="server" ID="lblItemList" Text=" Display With Items List:" Font-Bold="true"> </asp:Label>
           ...
           <table width="375px">
                      ...
                      <tr>
                          ...
                          <td>  <asp:RadioButtonList runat="server" ID="displayByRadiobuttonList" RepeatDirection="Horizontal" Font-Bold="true" AutoPostBack="true" >
                <asp:ListItem Selected="True" Text="User Details" Value="UserDetails" />
        ...
        <asp:GridView runat="server" ID="gvExpenseByEmail"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Expense">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" ID="lnkExpense" Text='<%# Item.Liability %>'
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Discount">
                  ...
                  <asp:TemplateField HeaderText="Subsidy">
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblSubsidy" Text='<%#Bind("subsidy") %>'></asp:Label>
                    </ItemTemplate>
                       <FooterTemplate>
                        <asp:Label ID="lblTotalSubsidy" runat="server" Font-Bold="true"></asp:Label>
                    </FooterTemplate>
                    <HeaderStyle CssClass="alignright" />
                    <ItemStyle CssClass="alignright" />
                    <FooterStyle CssClass="alignright" />
                ...
                <asp:TemplateField HeaderText="Net Price">
                    <ItemTemplate>
                        <asp:Label ID="lblNetPrice" runat="server" Text='<%#Eval("net_price","{0:n}")%>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
    ...
    <asp:Panel ID="pnlExpenseByUserType" GroupingText="Expense" runat="server" Visible="false">
        ...
        <asp:GridView runat="server" ID="gvExpenseByUserType"
                      ...
                      ClientIDMode="Static" OnPageIndexChanging="gvExpenseByUserType_PageIndexChanging" OnRowDataBound="gvExpenseByUserType_RowDataBound">
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <EmptyDataTemplate>
                <span style="color: #CC3300"><b>No Records Found!</b> </span>
            </EmptyDataTemplate>
            <Columns>
                ...
                <asp:TemplateField HeaderText="Expense">
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblExpense" Text='<%# Item.Expense %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <asp:Label ID="lblTotalExpense" runat="server"></asp:Label>
                    </FooterTemplate>
     ...
     <asp:Panel ID="pnlExpensesByFoodItem" GroupingText="Expense" runat="server" Visible="false">
                <p>
            <asp:Label runat="server" ID="lblCurrentFilterByFoodItem" CssClass="currentfilter"></asp:Label>
        </p>        
        <asp:GridView runat="server" ID="gvExpensesByFoodItem"
                      AutoGenerateColumns="False"
                      CellPadding="4"
                      CssClass="dtTable"
                      ForeColor="white"
                      ...
                      ClientIDMode="Static" OnPageIndexChanging="gvExpenseByFoodItem_PageIndexChanging" OnRowDataBound="gvExpenseByFoodItem_RowDataBound">
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <EmptyDataTemplate>
                <span style="color: #CC3300"><b>No Records Found!</b> </span>
            </EmptyDataTemplate>
            <Columns>
                 <asp:TemplateField HeaderText="Food Name" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblFoodName" Text='<%# Item.FoodName %>'></asp:Label>
                    </ItemTemplate>
                    
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Rate">
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblRate" Text='<%# Item.Rate %>'></asp:Label>
                    </ItemTemplate>
                    <FooterStyle CssClass="norightborder" />
                </asp:TemplateField>
                 <asp:TemplateField HeaderText="Quantity">
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblQuantity" Text='<%# Item.Quantity %>'></asp:Label>
                    </ItemTemplate>
                    <FooterStyle CssClass="norightborder" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Expense">
        ...
        <%
            ...
            { %>
            <p class="paginginfo">
                You are viewing page <%= gvExpensesByFoodItem.PageIndex + 1 %> of <%= gvExpensesByFoodItem.PageCount %>
            </p>
        <% }
        %>
    </asp:Panel>
