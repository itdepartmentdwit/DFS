<%@ Page Title="Delivered Food Items Report" Language="C#" MasterPageFile="~/DFS.Master" AutoEventWireup="true" CodeBehind="DeliveredItemsReport.aspx.cs" Inherits="DFS.Web.Report.DeliveredItemsReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="pnlDateSelector" runat="server" GroupingText="Delivered Items Report" CssClass="fivepixelbottommargin">
