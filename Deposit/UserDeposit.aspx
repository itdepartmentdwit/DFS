<%@ Page Title="Deposit History" Language="C#" MasterPageFile="~/DFS.Master" AutoEventWireup="true"
    CodeBehind="UserDeposit.aspx.cs" Inherits="DFS.Web.Deposit.UserDeposit" %>
    ...
    <asp:UpdatePanel ID="upanelDeposits" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <div class="deposit_item">
                <asp:LinkButton ID="lnkAddStudentDeposit" runat="server" CssClass="btn" OnClick="lnkAddStudentDeposit_Click">Add DWIT Student Deposit</asp:LinkButton>
                <br />
                    ...
                    <asp:GridView ID="gvDeposits" runat="server" ForeColor="#333333" AutoGenerateColumns="False" AllowPaging="True" GridLines="Both" CssClass="Grid" Width="100%"
                        ...
                        <Columns>
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lbldwituserdeposit_id" Text='<%#Eval("DWITUserDepositID") %>' runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="ModifiedByName" HeaderText="Modified By" SortExpression="ModifiedBy" />
                            <asp:TemplateField Visible="false">
                                <ItemStyle Width="50px" />
                                <ItemTemplate>
                                    <asp:LinkButton runat="server" ID="lnkItemEdit" CommandArgument='<%#Eval("DWITUserDepositID") %>'
