<%@ Page Title="Add Student Deposit" Language="C#" AutoEventWireup="true" CodeBehind="AddDeposit.aspx.cs" MasterPageFile="~/DFS.Master" Inherits="DFS.Web.StudentDeposit.AddDeposit" %>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RegularExpressionValidator ID="regvAmount" ValidationExpression="^\d+(\.\d\d)?$"
                                                                    ...
                                                                    ControlToValidate="txtAmount">* The amount is invalid</asp:RegularExpressionValidator>
                                    
                                    <asp:RangeValidator ID="RangeValAmount" runat="server" ControlToValidate="txtAmount" 
                                                        Display="Dynamic" ForeColor="Red" ValidationGroup="Amount" ErrorMessage="Amount should be between 1000 to 10000."
                                                        MaximumValue="10000" MinimumValue="1000" Type="Currency"><br/>* Amount should be between 1000 to 10000.
                                    </asp:RangeValidator>
                                    <asp:RequiredFieldValidator ID="rfAmount" ControlToValidate="txtAmount" ValidationGroup="Amount"
                                                                Display="Dynamic" CssClass="aaa" runat="server" ForeColor="Red" ErrorMessage="Amount is required.">* Amount is required</asp:RequiredFieldValidator>
                                    <br />
                                    <%--    "^\d+(\.\d\d)?$"--%>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:CompareValidator ID="CvAmount" runat="server" Operator="Equal" ControlToValidate="txtConfirmAmount"
                                                          ...
                                                          Display="Dynamic" ValidationGroup="Amount" ForeColor="Red">* The Amount Didn't Match</asp:CompareValidator>
                                    <br />
                                </td>
                            </tr>
                            <tr>
